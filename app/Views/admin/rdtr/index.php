    ...
    $(document).ready(function () {
        $("#table-search").on("keyup", function () {
            ...
            $("table tbody tr").filter(function () {
                // Only search if there's data (not the 'empty' row)
        ...
        <div class="d-flex gap-2 align-items-center flex-grow-1 flex-md-grow-0">
            <div class="input-group input-group-sm">
                ...
                <input type="text" id="table-search" class="form-control border-start-0 ps-0"
                    placeholder="Cari nama zona atau peruntukan...">
            </div>
            <a href="<?= base_url('admin/rdtr/export') ?>"
                class="btn btn-light fw-700 rounded-3 px-3 border border-danger border-opacity-10 text-danger d-none d-md-inline-block">
                <i class="bi bi-file-pdf"></i>
            </a>
            <a href="<?= base_url('admin/rdtr/create') ?>"
                class="btn btn-primary fw-700 rounded-3 px-3 shadow-sm text-nowrap">
